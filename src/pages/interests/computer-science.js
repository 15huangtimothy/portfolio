...
import mello from "../../images/mello.png"
import portfolioLogo from "../../images/icon.png"

const ComputerScience = () => (
    <InterestLayout>
        <h3 className="interest-header">Computer Science</h3>
        <p className="interest-intro">
            I'm interested in full stack software development! At UC Berkeley,
            I've completed computer science coursework in Data Structures and
            Artificial Intelligence. In addition, I'm experienced with React web
            development through various personal side projects. This site
            displays some of my work in both frontend and backend development.
        </p>
        <Project title="mello" image={mello} learn_more="#">
        ...
        <Project title="Dungeon Generation Game Engine" image="" learn_more="">
        ...
        <Project title="Bear Maps" image="" learn_more="">
